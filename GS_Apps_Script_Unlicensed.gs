// ============================================================
//  MAILING CAMPAIGN TEMPLATE — Apps Script  [ UNLICENSED ]
//  Paste this entire script into Extensions > Apps Script
// ============================================================
//
//  🔓  UNLICENSED VERSION
//  This script runs independently without any LandValuator
//  account verification. For personal use only — no web app
//  connection required.
//
