// ============================================================
//  MAILING CAMPAIGN TEMPLATE — Apps Script  [ LICENSED ]
//  Paste this entire script into Extensions > Apps Script
// ============================================================
//
//  🔐  LICENSED VERSION
//  This script requires the spreadsheet to be connected to a
//  LandValuator account. Functions are blocked on unauthorized
//  copies. See landvaluator.app to connect a sheet.
//
